...
public class DevTools_VerifyNetworkSpeed {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        devTools.send(Network.emulateNetworkConditions(true, 3000, 20000, 10000, Optional.of(ConnectionType.ETHERNET), Optional.empty(), Optional.empty(), Optional.empty()));
